...
# print(data_structure[3]["management"]["VP"]["direct_reports"]


# printing the no.s of 'direct_reports' of Cloud Infrastructure division
print(len(data_structure[3]["management"]["direct_reports"]))
